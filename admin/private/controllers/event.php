        ...
        if (Helper::is_post()) {
            if((empty($pgEventId)) && ($pgEventAction == "add")) {
                ...
                if((isset($viewEventArray['id'])) && (!empty($viewEventArray['id']))) {
                    ...
                    $eventSubCategoryStr = "";
                    /*if((isset($_POST['eventSubCategory'])) && (!empty($_POST['eventSubCategory']))) {
                        $eventSubCategoryStr = implode(",", $_POST['eventSubCategory']);
                    }*/

                    //$event->sub_category_id = $eventSubCategoryStr;
