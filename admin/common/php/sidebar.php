<?php
  ...
  $payment = $attributes = $orders = $sub_categories = $venues = $contacts = $bookings = $users = "";

  if($current == "index.php") $index = "active";
  else if(($current == "admin-users.php")) $admin_user = "active";
  ...
  else if(($current == "events.php") || ($current == "event-type.php") || ($current == "event-category.php") || ($current == "event-subcategory.php")) $events = "active";
  else if(($current == "users.php")) $users = "active";
  else if($current == "venues.php") $venues = "active";
  else if($current == "bookings.php") $bookings = "active";
  ...
  else if($current == "settings.php") $settings_data = "active";
  else if($current == "site-config.php") $settings_data = "active";
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="#" class="nav-link <?=$settings_data?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <a href="site-config.php" class="nav-link">
