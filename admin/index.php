...
<?php
  ...
  $venuesCount = new Venue();
  $all_venues = (array) $venuesCount->where(["admin_id" => $admin->id])->all();

  $venueCount = 0;
  if(!empty($all_venues)) {
    $venueCount = count($all_venues);
  }
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $venueCount; ?><!--<sup style="font-size: 20px">%</sup>--></h3>
                <p>Venue(s)</p>
              </div>
              <div class="icon">
