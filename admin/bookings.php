...
<?php
    ...
    if(!empty($admin)){
        ...
        $column = "";
        $column = "bookings.id AS bookingsId, bookings.name AS bookingsName, bookings.event_id AS bookingsEventId, bookings.venue_id AS bookingsVenueId, bookings.user_id AS bookingsUserId, bookings.status AS bookingsStatus, bookings.admin_id AS bookingsAdminId, bookings.created AS bookingsCreated, ";
        $column .= "event.id AS eventId, event.title AS eventTitle, event.venue AS eventVenueId, event.address AS eventAddress, event.start_date AS eventStartDate, event.end_date AS eventEndDate, event.status AS eventStatus, event.state_id AS eventState, event.city_id AS eventCity, event.country_id AS eventCountry, event.admin_id AS eventAdmin, event.type_id AS eventType, event.category_id AS eventCategory, event.category_type_id AS eventCategoryType, event.image_name AS eventImageName, event.sub_category_id AS eventSubCategoryId, ";  
        $column .= "venue.id AS venueId, venue.title AS venueTitle, venue.address AS venueAddress, venue.state AS venueState, venue.city AS venueCity, venue.country AS venueCountry, venue.status AS venueStatus, venue.admin_id AS venueAdminId, ";
        $column .= "user.id AS userId, user.username AS userUserName, user.name AS userName ";

        $joinColumn['join_table_name1'] = "bookings";
        $joinColumn['join_table_name2'] = "event";
        $joinColumn['join_table_name3'] = "venue";
        $joinColumn['join_table_name4'] = "user";

        $joinColumn['join_column_name1'] = "event_id";
        $joinColumn['join_column_name2'] = "venue_id";
        $joinColumn['join_column_name3'] = "user_id";
        $joinColumn['join_column_child'] = "id";

        $all_bookings = (array) $bookings->orderBy('id')->orderType('desc')->allWithJoin($column, $joinColumn);
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
                  ...
                  <tbody>
                    <?php
                        ...
                        exit;
                            ...
                            [bookingsId] => 1
            [bookingsName] => Praneetha
            [bookingsEventId] => 11
            [bookingsVenueId] => 4
            [bookingsUserId] => 560
            [bookingsStatus] => 1
            [bookingsAdminId] => 1
            [bookingsCreated] => 2019-09-18 05:21:14
            [eventId] => 11
            [eventTitle] => Thirumal Alagu Memorial Trophy
            [eventVenueId] => 
            [eventAddress] => SK Academy
            [eventStartDate] => 09/02/2023 9:24 PM
            [eventEndDate] => 09/04/2023 7:55 PM
            [eventStatus] => 1
            [eventState] => 35
            [eventCity] => 4183
            [eventCountry] => 101
            ...
            [eventCategoryType] => 
            [eventImageName] => 
            [eventSubCategoryId] => 20
            [venueId] => 4
            [venueTitle] => KK Events
            [venueAddress] => no70/38 venkadatri nilayam, first floor, door no 101
            [venueState] => 35
            [venueCity] => 4183
            [venueCountry] => 101
            [venueStatus] => 1
            ...
            [userName] => kirubakaran
                    ...
                    ?>
                              <tr>
                                <td>
                                    <?php echo $item->bookingsId; ?>
                                </td>
                                <td>
                                    <?php echo $item->bookingsName; ?>
                                </td>
                                <td>
                                    <?php echo $item->eventTitle; ?>
                                </td>
                                <td>
                                    <?php echo $item->venueTitle; ?>
                                </td>
                                <td>
