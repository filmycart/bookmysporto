									...
									<div class="col-12 col-sm-12 col-md-6 col-lg-4">
										<div class="listing-item">
											<div class="listing-img">
												<a href="index.php?pg-name=event-details?eid=<?=(!empty($eventResponseVal['eventId'])?$eventResponseVal['eventId']:'')?>"><?=(!empty($eventResponseVal['eventTitle'])?$eventResponseVal['eventTitle']:'')?>
											...
											<div class="listing-content">
												...
												<h4 class="listing-title">
													<a href="index.php?pg-name=event-details?eid=<?=(!empty($eventResponseVal['eventId'])?$eventResponseVal['eventId']:'')?>"><?=(!empty($eventResponseVal['eventTitle'])?$eventResponseVal['eventTitle']:'')?></a>
												</h4>
											</div>
										</div>
									</div>
