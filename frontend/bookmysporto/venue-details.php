...
<head>
	...
	<link rel="stylesheet" href="<?=$frontendAssetUrl?>assets/css/bootstrap-datetimepicker.min.css">
...
<body>
		...
		<div class="bannergallery-section">
		    <div class="main-gallery-slider owl-carousel owl-theme">
                <div class="gallery-widget-item">
				    <a href="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-01.png" data-fancybox="gallery1">
						<img class="img-fluid" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-01.png">
					</a>
				</div>	
                <div class="gallery-widget-item">
				    <a href="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-02.png" data-fancybox="gallery1">
						<img class="img-fluid" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-02.png">
					</a>
				</div>								
				<div class="gallery-widget-item">
					<a href="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-03.png" data-fancybox="gallery1">
						<img class="img-fluid" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-03.png">
					</a>
				</div>	
                <div class="gallery-widget-item">
					<a href="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-04.png" data-fancybox="gallery1">
						<img class="img-fluid" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-04.png">
					</a>
				</div>
				<div class="gallery-widget-item">
					<a href="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-05.png" data-fancybox="gallery1">
						<img class="img-fluid" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-05.png">
					</a>
				</div>
				<div class="gallery-widget-item">
				    <a href="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-01.png" data-fancybox="gallery1">
			...
			<div class="showphotos corner-radius-10">
				<a href="<?=$frontendAssetUrl?>assets/img/gallery/gallery1/gallery-03.png" data-fancybox="gallery1"><i class="fa-regular fa-images"></i>More Photos</a>
			</div>			
		</div>		
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-6">
						...
						<ul class="d-sm-flex justify-content-start align-items-center">
							...
							<li><i class="feather-mail"></i><a href="mailto:yourmail@example.com"> yourmail@example.com</a></li>
						</ul>
					</div>
				...
				<div class="row bottom-row d-flex align-items-center">
					<div class="col-12 col-sm-12 col-md-6 col-lg-6">
						<ul class="d-sm-flex details">
							...
							<li>
								<div class="profile-pic">
									<a href="javascript:void(0);"><img class="img-fluid"  src="<?=$frontendAssetUrl?>assets/img/profiles/avatar-01.jpg" alt="Icon"></a>
								</div>
								<div class="ms-2">
									<p>Added By</p>
							    ...
							    <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-gallery">
							      	<div class="accordion-body">
							        	<div class="owl-carousel gallery-slider owl-theme">
							        		<a class="corner-radius-10" href="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-thumb-01.jpg" data-fancybox="gallery3">
												<img class="img-fluid corner-radius-10" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-01.jpg">
											</a>
							        		<a class="corner-radius-10" href="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-thumb-02.jpg" data-fancybox="gallery3">
												<img class="img-fluid corner-radius-10" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-02.jpg">
											</a>
							        		<a class="corner-radius-10" href="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-thumb-03.jpg" data-fancybox="gallery3">
												<img class="img-fluid corner-radius-10" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-03.jpg">
											</a>
							        		<a class="corner-radius-10" href="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-thumb-01.jpg" data-fancybox="gallery3">
												<img class="img-fluid corner-radius-10" alt="Image" src="<?=$frontendAssetUrl?>assets/img/gallery/gallery2/gallery-01.jpg">
											</a>
						...
						<div class="white-bg listing-owner">
							...
							<ul>
								<li class="d-flex justify-content-start align-items-center">
									<div class="">
										<a href="blog-details.html"><img class="img-fluid" alt="Venue" src="<?=$frontendAssetUrl?>assets/img/listing-by-owner-01.jpg"></a>
									</div>
								...
								<li class="d-flex justify-content-start align-items-center">
									<div class="">
										<a href="blog-details.html"><img class="img-fluid" alt="Venue" src="<?=$frontendAssetUrl?>assets/img/listing-by-owner-02.jpg"></a>
									</div>
									<div class="owner-info">
	...
	<!-- Bootstrap DateTime Picker -->
	<script src="<?=$frontendAssetUrl?>assets/js/moment.min.js"></script>
	<script src="<?=$frontendAssetUrl?>assets/js/bootstrap-datetimepicker.min.js"></script>
