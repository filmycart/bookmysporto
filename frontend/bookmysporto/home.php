			        		...
			        		<?php
			        			if((isset($eventResponseHomePageArr['data'])) && (!empty($eventResponseHomePageArr['data']))) {
			        				foreach($eventResponseHomePageArr['data'] as $eventResponseHomePageVal) {
			    						...
			    						$eventStartMonthYear = "";   
			    						if((isset($eventResponseHomePageVal['eventStartDate'])) && (!empty($eventResponseHomePageVal['eventStartDate']))) {
			        						$eventStartMonthYear = date("M Y", strtotime($eventResponseHomePageVal['eventStartDate']));
										}	
										...
										$eventEndMonthYear = "";   
			    						if((isset($eventResponseHomePageVal['eventEndDate'])) && (!empty($eventResponseHomePageVal['eventEndDate']))) {
			        						$eventEndMonthYear = date("M Y", strtotime($eventResponseHomePageVal['eventEndDate']));
										}		
			        		?>
											...
											<div class="listing-item mb-0">										
												...
												<div class="listing-content">
													...
													<div class="listing-button">
														<a href="index.php?pg-nm=event-details&id=<?=(!empty($eventResponseHomePageVal['eventId'])?$eventResponseHomePageVal['eventId']:'')?>" class="user-book-now"><span><i class="feather-calendar me-2"></i></span>Event Details</a>
