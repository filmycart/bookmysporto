                    ...
                    <?php
                        ...
                        if((isset($_SESSION['userId'])) && (!empty($_SESSION['userId']))) {
                            if((isset($_SESSION['userImage'])) && (!empty($_SESSION['userImage']))) {
                                if($hostName == "localhost") {
                                    $profileImage = "/bookmysporto/admin/uploads/users/".$_SESSION['userImage'];
                                } else {
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="user" role="tabpanel" aria-labelledby="user-tab">
                            <form id="userRegisterForm" name="userRegisterForm" method="POST" enctype="multipart/form-data" action="./././api/user/register.php">
                                ...
                                <div class="row">   
                                    <div class="col-sm-12 col-md-12 col-lg-12 left-padding">
                                        <div id="userImageSpinnerDiv"><img src="./frontend/bookmysporto/assets/img/loader.png" class="loader"></div>
...
<?php
    ...
    $stateUrl = "";
    if($hostName == "localhost") {
        $stateUrl = $requestScheme.'://localhost/bookmysporto/api/location/state.php';
    } else {
    ...
    $venueUrl = "";
    if($hostName == "localhost") {
        $venueUrl = $requestScheme.'://localhost/bookmysporto/api/venue/venue.php';
    } else {
    ...
    $eventUrlHomePage = "";
    if($hostName == "localhost") {
        $eventUrlHomePage = $requestScheme.'://localhost/bookmysporto/api/event/event.php';
    } else {
